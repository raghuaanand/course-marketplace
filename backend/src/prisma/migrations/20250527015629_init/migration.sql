...
-- CreateEnum
CREATE TYPE "LessonType" AS ENUM ('VIDEO', 'TEXT', 'QUIZ', 'DOWNLOADABLE');

-- CreateEnum
CREATE TYPE "QuizType" AS ENUM ('MCQ', 'FILL_IN_BLANKS', 'TRUE_FALSE');
...
-- AddForeignKey
ALTER TABLE "quiz_submissions" ADD CONSTRAINT "quiz_submissions_enrollmentId_fkey" FOREIGN KEY ("enrollmentId") REFERENCES "enrollments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
